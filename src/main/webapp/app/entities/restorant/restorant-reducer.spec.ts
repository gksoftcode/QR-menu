...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './restorant.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RESTORANT_LIST actions', async () => {
    ...
    it('dispatches FETCH_RESTORANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RESTORANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RESTORANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RESTORANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RESTORANT actions', async () => {
      const expectedActions = [
        {
