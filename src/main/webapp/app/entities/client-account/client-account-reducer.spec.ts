...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLIENTACCOUNT_LIST actions', async () => {
    ...
    it('dispatches FETCH_CLIENTACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CLIENTACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CLIENTACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CLIENTACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CLIENTACCOUNT actions', async () => {
      const expectedActions = [
        {
